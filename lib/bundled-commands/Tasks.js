...
(function() {
  "use strict";
  var Gaze, Helpers, Promise, Tasks, browserSync, helpers, minimatch, path, shelljs, _;
  ...
  Tasks = (function() {
    ...
    Tasks.prototype.checkAndStartServer = function() {
      var self;
      self = this;
      helpers.getConfig(function(err, config) {
        if (err) {
    ...
    Tasks.prototype.startServer = function(config) {
      var serverConfig;
      serverConfig = {
        server: {
      ...
      browserSync(serverConfig, function(err, bs) {
        if (err) {
          console.log(err);
        } else {
    ...
    Tasks.prototype.reloadServer = function() {
      browserSync.reload();
    };
