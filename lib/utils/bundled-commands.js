...
(function() {
  var BundledCommands, Helpers, findup, fs, helpers, inquirer, karma, path, shelljs;
  ...
  BundledCommands = (function() {
    ...
    BundledCommands.prototype.newApp = function(args) {
      ...
      git_questions = {
        ...
        validate: function(value) {
          var _ref;
          return (_ref = value.trim().length > 0) != null ? _ref : {
            "true": false
          };
        }
      };
    ...
    BundledCommands.prototype.buildApp = function(args) {
      shelljs.cd(process.cwd());
      return shelljs.exec("node node_modules/ngcli-task-runner/index.js --build");
    };
    ...
    BundledCommands.prototype.installAddon = function(args) {
      findup(process.cwd(), 'package.json', function(err, dir) {
        ...
        shelljs.cd(dir);
        shelljs.exec("npm install " + args.name + " --save", function(code, output) {
    ...
    BundledCommands.prototype.serveApp = function(args) {
      shelljs.cd(process.cwd());
      return shelljs.exec("node node_modules/ngcli-task-runner/index.js --serve");
    };
    ...
    BundledCommands.prototype.karmaStart = function(args) {
      shelljs.cd(process.cwd());
      return shelljs.exec("node node_modules/ngcli-task-runner/index.js --test");
    };
